    ...
    @if(Auth::check())
            ...
            <template v-if="menu==1">            
                <cartagarantia :ruta="ruta"></cartagarantia>
            </template>
            ...
            <template v-if="menu==14">
                <AtencionDirecta :ruta="ruta"></AtencionDirecta>
            </template>
            <template v-if="menu==15">
                <ConVacunacion :ruta="ruta"></ConVacunacion>
            </template>
            <template v-if="menu==16">
                <CartaGarantiaClinica :ruta="ruta"></CartaGarantiaClinica>
            </template>
