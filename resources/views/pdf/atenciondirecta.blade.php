...
<body>
<div class="cabecera">
    <span ><IMG SRC="img/logo_pdf.png" style="width:28mm"></span>
    </div>
    <div class="titulo">
    <h3 >ATENCIÓN DIRECTA N° {{ $codigo }}</h3>
    </div>
    ...
    <div class="cie10">
    <span ><IMG SRC="img/cie10_2.png" ></span>
    </div>
   <br>
