...
Vue.component('cartagarantia', require('./components/CartaGarantia.vue'));
Vue.component('cartagarantiaclinica', require('./components/CartaGarantiaClinica.vue'));
...
Vue.component('convacunacion', require('./components/ConVacunacion.vue'));
Vue.component('atenciondirecta', require('./components/AtencionDirecta.vue'));
