            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Ubicaciones
    ...
    export default {
        ...
        methods : {
            listarCategoria (page,buscar,criterio){
                let me=this;
                var url=this.ruta + '/ubicacion?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarCategoria(){
                ...
                axios.post(this.ruta + '/ubicacion/registrar',{
                    'nombre': this.nombre,
                ...
                switch(modelo){
                    case "categoria":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar Ubicacion';
                                this.nombre= '';
                                this.descripcion = '';
                                this.tipoAccion = 1;
                                break;
                            ...
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.modal=1;
                                this.tituloModal='Actualizar Ubicacion';
                                this.tipoAccion=2;
