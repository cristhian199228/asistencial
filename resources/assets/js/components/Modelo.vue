                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    ...
                                    <td v-text="categoria.moddesc"></td>
                                    <td v-text="categoria.marcdesc"></td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="comentario" class="form-control" placeholder="Ingrese Comentario">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="id_marca">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="marcas in arrayMarca" :key="marcas.id" :value="marcas.id" v-text="marcas.descripcion"></option>
                                        </select>                                        
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            listarCategoria (page,buscar,criterio){
                let me=this;
                var url=this.ruta + '/modelo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            actualizarMarca(){
               if (this.validarMarca()){
                ...
                axios.put(this.ruta + '/marca/actualizar',{
                    'descripcion': this.descripcion,
                    'comentario': this.comentario,
            ...
            validarMarca(){
             ...
             selectMarca(){
                let me=this;
                var url= this.ruta + '/marca/selectMarca';
                axios.get(url).then(function (response) {
