            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Cartas de Garantia Clinica
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th width="400">Paciente</th>
                                    <th>Especialista/Especialidad</th>
                                    <th>Fecha</th>
                                    <th>Fecha Validez</th>
                                    <th>Estado</th>
                                </tr>
            ...
            ImprimirAtencionDirecta(categoria){
                ...
                if (result.value) {
                    ...
                    params: {
                        ...
                        fecha_atencion_validez:this.fecha_atencion_validez[0] + '-' + this.fecha_atencion_validez[1] + '-' + this.fecha_atencion_validez[2]
