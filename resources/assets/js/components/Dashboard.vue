    ...
    <div class="container-fluid">
          <div class="animated fadeIn">
            <div class="card-columns cols-2">
              <div class="card">
                <div class="card-header">Pagos de personas
              ...
              <div class="card">
                <div class="card-header">Pagos de Alquiler
                  <div class="card-header-actions">
                    <a class="card-header-action" href="http://www.chartjs.org" target="_blank">
                      <small class="text-muted">2019</small>
                    </a>
              ...
              <div class="card">
                <div class="card-header">Pagos de personas -Barras
                  <div class="card-header-actions">
                    <a class="card-header-action" href="http://www.chartjs.org" target="_blank">
                      <small class="text-muted">2019</small>
                    </a>
              ...
              <div class="card">
                <div class="card-header">Pagos de Alquiler -Barras
                  <div class="card-header-actions">
                    <a class="card-header-action" href="http://www.chartjs.org" target="_blank">
                      <small class="text-muted">2019</small>
                    </a>
              ...
              <div class="card">
                <div class="card-header">Personas por estado de pago
                  <div class="card-header-actions">
                    <a class="card-header-action" href="http://www.chartjs.org" target="_blank">
                      <small class="text-muted">2019</small>
                    </a>
              ...
              <div class="card">
                <div class="card-header">Pagos por tipo de deuda
                  <div class="card-header-actions">
                    <a class="card-header-action" href="http://www.chartjs.org" target="_blank">
                      <small class="text-muted">2019</small>
                    </a>
...
var radarChart = new Chart($('#canvas-4'), {
  type: 'radar',
  data: {
    labels: ['MZ A', 'MZ B', 'MZ C', 'MZ D','MZ E'],
    datasets: [{      
      label: 'Pagaron',
      backgroundColor: 'rgba(220, 220, 220, 0.2)',
      borderColor: 'rgba(220, 220, 220, 1)',
