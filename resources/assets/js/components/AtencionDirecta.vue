            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Atenciones Directas
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      ...
                                      <option value="id">Numero de Carta</option>
                                    </select>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarAtencionDirecta()">Guardar</button>
    ...
    export default {
        ...
        methods : {
            listarCategoria (page,buscar,criterio){
                ...
                let me=this;
                var url=this.ruta + '/atenciondirecta?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarAtencionDirecta(){
                ...
                */                
                let me = this;
                axios
                .post(this.ruta + '/atenciondirecta/registrar',{
                ...
                var myWindow=window.open('','','');
                    ...
                    myWindow.document.write("<tr height='42'>");
                    myWindow.document.write("<td width = '492'>");
                    ...
                    myWindow.document.write("</td>");
                    myWindow.document.write("<td width = '327'>");
                    ...
                    myWindow.document.write("</table>");
                    myWindow.document.write("<table border='0'  width='700'>");
                    myWindow.document.write("<tr height='35'>");
                    myWindow.document.write("<td width = '90'>");
                    myWindow.document.write("</td>");
                    myWindow.document.write("<td width = '320'>");
                    ...
                    myWindow.document.write("<table border='0'  width='700'>");
                    myWindow.document.write("<tr>");
                    myWindow.document.write("<td width = '87'>");
                    myWindow.document.write("</td>");
                    myWindow.document.write("<td>");
            ...
            ImprimirAtencionDirecta(categoria){
                ...
                if (result.value) {
                    ...
                    axios
                    .get(this.ruta +'/descargarPDF_ad',
                    {responseType: 'arraybuffer',
                    headers: {
                     'Accept' : 'application/pdf'
                    },
                    params: {
                        codigo: 'PD'+categoria.codigo,
                        nombre_titular:this.nombre_titular,
                        edad_titular:this.edad_titular_imp,
                        codigo_titular:this.codigo_titular,
                        nombre_paciente:categoria.USU_APELLIDOS+' '+ categoria.USU_NOMBRES,
                        edad_paciente:this.edad_paciente_imp,
                        codigo_paciente:this.codigo_paciente_imp+'-'+categoria.NIV_ID,
                        especialidad:categoria.nombre_provedor +' / '+ categoria.nombre_especialidad,
                        fecha_atencion:this.fecha_atencion[0] + '-' + this.fecha_atencion[1] + '-' + this.fecha_atencion[2]                   
                        }})
                    .then(response => {
                    ...
                    case "categoria":
                    {
                        switch(accion){
                            ...
                            {   
                                ...
                                this.fecha_actual_imp = dd + '&nbsp;&nbsp;&nbsp;' + mm + '&nbsp;&nbsp;&nbsp;' + yy;
